...
const blogMeta: Record<string, BlogSEO> = {
  ...
  "new-link-road-mohali-2026-impact-property-prices-connectivity": {
    ...
    description: "Discover how GMADA's proposed 8.5 km link road will reduce Airport Road congestion, improve access to Aerocity and IT City, and drive property price appreciation across Mohali.",
