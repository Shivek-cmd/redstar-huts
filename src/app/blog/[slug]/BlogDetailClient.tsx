...
const blogContent: Record<string, ContentBlock[]> = {
  "chandigarh-tricity-metro-project-real-estate-opportunity": [
    ...
    { type: "image", value: "/blog/tricity-metro/metro-station.jpg", alt: "Indian metro train station with passengers and elevated rail infrastructure" },
    ...
    { type: "image", value: "/blog/tricity-metro/property-investment.jpg", alt: "Residential property investment with modern apartment buildings and keys" },
    ...
    { type: "image", value: "/blog/tricity-metro/urban-development.jpg", alt: "Modern commercial high-rise buildings representing urban real estate growth and infrastructure development" },
    ...
    { type: "image", value: "/blog/tricity-metro/luxury-residential.jpg", alt: "Modern luxury residential property with landscaped surroundings ideal for family homebuyers" },
  ...
  "new-link-road-mohali-2026-impact-property-prices-connectivity": [
    ...
    { type: "paragraph", value: "To address this, the Greater Mohali Area Development Authority (GMADA) has proposed a new 8.5 km link stretch road designed to improve connectivity, reduce traffic pressure, and open up new corridors for growth. For homebuyers and investors, this project signals a significant shift in how Mohali's infrastructure will shape property values in the years ahead." },
    { type: "heading", value: "What Is the New 8.5 km Link Road Project?" },
    ...
    { type: "paragraph", value: "Length \u2014 Approximately 8.5 km of modern, dual-carriageway road." },
    ...
    { type: "paragraph", value: "Mohali has already established itself as a premium real estate destination thanks to its modern infrastructure, IT sector growth, and airport connectivity. The new 8.5 km link road will further cement this position." },
